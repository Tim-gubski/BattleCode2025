...
# https://github.com/battlecode/battlecode25/blob/master/client/src/constants.ts
...
def run_matches(player1: str, player2: str, mymaps: list[str], timestamp: str) -> dict[str, Any]:
    ...
    proc = subprocess.Popen(args, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, cwd=str(Path(__file__).parent.parent))
