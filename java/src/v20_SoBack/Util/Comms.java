...
public class Comms {
    ...
    public void parseMessages() throws GameActionException{
        ...
        if (round > 0) {
            ...
            for (Message message : rc.readMessages(rc.getRoundNum() - turnsBack)) {
    ...
    public int constructMessage(Codes code, MapLocation loc, UnitType towerType) {
        ...
        switch (code) {
            ...
            case MOPPER_LOC -> {
                ...
                message = combineMessage(Codes.MOPPER_LOC.getPrefix(), xPaddedBinary, yPaddedBinary);
            }
