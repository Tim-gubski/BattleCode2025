package v07_Timfactor;

import v07_Timfactor.Helpers.Explore;
import v07_Timfactor.Helpers.MapData;
...
public abstract class Unit extends Robot {
    ...
    public boolean isSafe(MapLocation loc, RobotInfo[] enemies) throws GameActionException {
        ...
        MapInfo info = rc.senseMapInfo(loc);
        if ((isEnemyPaint(info.getPaint()) && rc.getPaint() < rc.getType().paintCapacity * 0.25) ||
                (info.getPaint() == PaintType.EMPTY && rc.getPaint() < rc.getType().paintCapacity * 0.4)) {
            return false;
        }
    ...
    MapLocation[] prevPositions = new MapLocation[3];
    int prevPosIndex = 0;
