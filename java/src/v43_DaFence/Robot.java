...
import v43_DaFence.Helpers.Explore;
import v43_DaFence.Helpers.MapData;
import v43_DaFence.Util.Symmetry;
...
//    }
    ...
    public UnitType determineTowerPattern(MapLocation ruinLoc) {
//        if(ruinLoc.distanceSquaredTo(new MapLocation(width/2, height/2)) < 50){
//            return UnitType.LEVEL_ONE_DEFENSE_TOWER;
//        }
        double ratio = mapData.friendlyTowers.moneyTowers < 4 ? 2 : 1.5;
