package v15_SmartFella;

import v15_SmartFella.Helpers.Explore;
import v15_SmartFella.Helpers.MapData;
import v15_SmartFella.Util.Symmetry;
import v15_SmartFella.Util.Comms;
...
//       }
//       return UnitType.LEVEL_ONE_MONEY_TOWER;
        if(mapData.friendlyTowers.moneyTowers <= (Math.max(mapData.friendlyTowers.paintTowers, 1))*2){
            return UnitType.LEVEL_ONE_MONEY_TOWER;
        }else{
            return UnitType.LEVEL_ONE_PAINT_TOWER;
        }
