package v15_SmartFella.Units;

import v15_SmartFella.Unit;
        ...
        if (enemyPaintDirection != null && enemyPaintDirection != Direction.CENTER) {
            ...
            if (isEnemyPaint(rc.senseMapInfo(rc.getLocation()).getPaint())) {
                ...
                for(Direction dir : fuzzyDirs(enemyPaintDirection)){
                    if(rc.onTheMap(rc.getLocation().add(dir)) && !mapData.getMapInfo(rc.getLocation().add(dir)).getPaint().isEnemy() && rc.canMove(dir)){
                        rc.move(dir);
                        break;
                    }
                }
