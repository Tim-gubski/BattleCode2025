package v15_SmartFella.Helpers;

import battlecode.common.*;
import v15_SmartFella.Helpers.Fast.FastIterableLocSet;
import v15_SmartFella.Robot;
...
//            }
    ...
    int[][] exclusionOffsets = new int[][]{
            {-4, -2}, {-4, -1}, {-4, 1}, {-4, 2},
            {-3, -3}, {-3, -2}, {-3, -1}, {-3, 0}, {-3, 1}, {-3, 2}, {-3, 4},
            {-2, -4}, {-2, -3}, {-2, 3}, {-2, 4},
            {-1, -4}, {-1, -3}, {-1, 3}, {-1, 4},
            {0, -3}, {0, 3},
            {1, -4}, {1, -3}, {1, 3}, {1, 4},
            {2, -4}, {2, -3}, {2, 3}, {2, 4},
            {3, -4}, {3, -2}, {3, -1}, {3, 0}, {3, 1}, {3, 2}, {3, 4},
            {4, -2}, {4, -1}, {4, 1}, {4, 2},
    };
