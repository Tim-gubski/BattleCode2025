...
//        }
        ...
        if(targetEnemy != null && (!bestNearRuin || closeToHomeTower)){// || (spawnTower != null && distTo(spawnTower) < 100))){
            return UnitState.COMBAT;
        }
...
//        }
    ...
    private void combatState() throws GameActionException{
        ...
        if(maxEnemiesHit >= 2 && rc.isActionReady() && (rc.getPaint() > 30 || mapData.getMapInfo(rc.getLocation()).getPaint().isAlly())){ // TODO optimize by paint remaining maybe
