...
public abstract class Tower extends Robot {
    ...
    public void turn() throws GameActionException {
        if(rc.getChips()>3000 && rc.canUpgradeTower(rc.getLocation()) && rc.senseNearbyRobots(-1, rc.getTeam()).length > 3){
        ...
        if(enemyPaint){
            ...
            if (rc.senseNearbyRobots(-1, rc.getTeam()).length < 5 && (spawnTurn - startSpawnTurn < 10 || rc.getChips() > 1000)) {
                if (spawnTurn % 5 < 2) {
