package v52_SleepyBAD;

import v52_SleepyBAD.Util.Comms;
...
//            }
    ...
    public void bugNav(MapLocation loc) throws GameActionException{
        ...
        if(bugStackIndex == 0){
            ...
            int score = tileScore(rc.getLocation().add(dirToTarget), ignoreEmpty);
            if(rc.canMove(dirToTarget) && score > bestScore && !rc.getLocation().add(dirToTarget).equals(lastLocation)){
                bestDir = dirToTarget;
                bestScore = score;
            }
            if(rc.canMove(dirToTarget.rotateLeft()) && (score = tileScore(rc.getLocation().add(dirToTarget.rotateLeft()), ignoreEmpty)) > bestScore && !rc.getLocation().add(dirToTarget.rotateLeft()).equals(lastLocation)){
                bestDir = dirToTarget.rotateLeft();
                bestScore = score;
            }
            if(rc.canMove(dirToTarget.rotateRight()) && (score = tileScore(rc.getLocation().add(dirToTarget.rotateRight()), ignoreEmpty)) > bestScore && !rc.getLocation().add(dirToTarget.rotateRight()).equals(lastLocation)){
