package v34_RushBotForTesting.Units;

import v34_RushBotForTesting.Unit;
...
public class Soldier extends Unit {
    ...
    final int ATTACK_HEALTH_THRESHOLD = 0;
    ...
    boolean shouldFillAround = false;
...
//                (mapData.friendlyTowers.paintTowers >= 1 || state == UnitState.BUILD || state == UnitState.BUILDSRP);// && rc.getPaint()>10;
...
//        if (completableSRP != null && mapData.friendlyTowers.size() >= SRP_TOWER_THRESHOLD && enemies.length == 0){
