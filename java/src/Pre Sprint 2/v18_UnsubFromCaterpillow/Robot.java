package v18_UnsubFromCaterpillow;

import v18_UnsubFromCaterpillow.Helpers.Explore;
import v18_UnsubFromCaterpillow.Helpers.MapData;
import v18_UnsubFromCaterpillow.Util.Symmetry;
import v18_UnsubFromCaterpillow.Util.Comms;
...
//       return UnitType.LEVEL_ONE_MONEY_TOWER;
        ...
        if(mapData.friendlyTowers.paintTowers > 0 && mapData.friendlyTowers.moneyTowers < mapData.friendlyTowers.paintTowers*2){
            return UnitType.LEVEL_ONE_MONEY_TOWER;
        }else{
            return UnitType.LEVEL_ONE_PAINT_TOWER;
        }
