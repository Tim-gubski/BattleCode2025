package v55_TowerTweaks.Units;

import v55_TowerTweaks.Unit;
            ...
            if (!checkAndPaintTile(rc.getLocation()) && rc.isActionReady()) {
                ...
                if(rc.isActionReady()) {
                    ...
                    if(closestCompletableRuin != null){
                        ...
                        MapLocation[] spiral = mapLocationSpiral(closestCompletableRuin, 2);
...
//            }
            ...
            // get in attack range
            if((rc.getRoundNum()%2==0 || numSoldiers == 0 || rc.getPaint() < UnitType.SOLDIER.paintCapacity*0.5) && rc.isActionReady()) {
//            if(rc.isActionReady()) {
...
//            }
    ...
    private UnitState buildState() throws GameActionException {
        ...
        if(markDir != null && rc.canSenseLocation(closestCompletableRuin)){
            ...
            if(markTowerType == UnitType.LEVEL_ONE_MONEY_TOWER && towerType != UnitType.LEVEL_ONE_MONEY_TOWER){
                Direction markDirection = towerTypeToMarkDirection(towerType);
                MapLocation markLocation = closestCompletableRuin.add(markDirection);
