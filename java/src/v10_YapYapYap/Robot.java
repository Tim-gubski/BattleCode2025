...
import v10_YapYapYap.Util.Symmetry;
...
//    }
    ...
    public void trySetIndicatorDot(MapLocation loc, int red, int green, int blue) throws GameActionException {
        if (rc.onTheMap(loc)) rc.setIndicatorDot(loc, red, green, blue);
    }

    public void trySetIndicatorLine(MapLocation startLoc, MapLocation endLoc, int red, int green, int blue) throws GameActionException {
        if (rc.onTheMap(startLoc) && rc.onTheMap(endLoc)) rc.setIndicatorLine(startLoc, endLoc, red, green, blue);
    }
}