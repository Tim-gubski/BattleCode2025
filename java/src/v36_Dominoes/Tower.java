...
//                enemyPaint = true;
        ...
        if(soldiers >= 1 && rc.getRoundNum() - emergencyMopperTurn > MOPPER_COOLDOWN){// && rc.getRoundNum() < 100){
        ...
        debugString.append("Need Moppers: " + needMoppers);
        // spawner logic
    ...
    public boolean trySummon(UnitType type) throws GameActionException{
        ...
        if(bestLoc != null){
            ...
            trySummonInDirection(type, randomDirection());
        }
        return false;
    }
